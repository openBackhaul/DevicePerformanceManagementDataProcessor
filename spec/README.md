...
- output formats:  
    - [apt-output-format](./Functions/p1StreamPmData/p1ProcessDevice/p1FormattingOutputApt/1.0.0/variables.yaml) :
      format already used for device-wise retrieval of PM data  
    - [onf-output-format](./Functions/p1StreamPmData/p1ProcessDevice/p1FormattingOutputOnf/1.0.0/variables.yaml) :
      post- filtered resultCc for universal ONF conform use  
