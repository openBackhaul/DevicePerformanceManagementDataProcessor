...
The following existing generic Functions are re-used in this application:  

- [oldGenericFunction](https://github.com/openBackhaul/ApplicationPattern/tree/develop/spec/genericFunctions/oldGenericFunction/1.0.0)  
