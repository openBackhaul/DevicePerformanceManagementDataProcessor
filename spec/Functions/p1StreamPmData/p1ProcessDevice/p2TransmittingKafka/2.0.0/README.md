...
p2TransmittingKafka receives the list of outputFormats.  
Each outputFormat is identified by its formatName.  
p2TransmittingKafka checks its parameters for an entry with purpose=="kafkaClient" and parameterName==formatName.  
...
<p align="center">  
  <img src="./p2TransmittingKafka.png" alt="p2TransmittingKafka diagram" width="400" />
</p>  
