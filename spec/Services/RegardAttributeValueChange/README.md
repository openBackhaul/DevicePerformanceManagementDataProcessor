...
At the end of the waiting period, it is initiating an instance of p1ProcessingPmData for every MountName it received during that period.  
...
The way of implementing the initiation of multiple p1ProcessingPmData instances assures a smooth resource consumption.  
