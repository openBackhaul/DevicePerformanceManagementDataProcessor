...
module.exports.getActionProfileInputValueList = async function getActionProfileInputValueList (req, res, next, uuid) {
  let responseCode = responseCodeEnum.code.OK;
  await ActionProfile.getActionProfileInputValueList(req.url)
    .then(function (response) {
      responseBuilder.buildResponse(res, responseCode, response);
    })
    .catch(function (response) {
