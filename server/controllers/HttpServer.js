...
module.exports.getHttpServerDataUpdatePeriod = async function getHttpServerDataUpdatePeriod(req, res, next, uuid) {
  let responseCode = responseCodeEnum.code.OK;
  await HttpServer.getHttpServerDataUpdatePeriod(req.url)
    .then(function (response) {
      responseBuilder.buildResponse(res, responseCode, response);
    })
    .catch(function (response) {
